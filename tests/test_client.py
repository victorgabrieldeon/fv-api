...
class TestFv:
    ...
    def test_client_timeout_option(self) -> None:
        client = Fv(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(FvError):
            with update_env(**{"FV_API_KEY": Omit()}):
                client2 = Fv(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Fv) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Fv(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(FV_BASE_URL="http://localhost:5000/from/env"):
            client = Fv(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Fv(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Fv(
    ...
    def test_base_url_trailing_slash(self, client: Fv) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Fv) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Fv) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Fv(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Fv(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/profit").mock(side_effect=retry_handler)
    ...
    @mock.patch("fv._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Fv, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.profit.with_raw_response.calculate(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        self, client: Fv, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.profit.with_raw_response.calculate(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncFv:
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncFv(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_multipart_repeating_array(self, async_client: AsyncFv) -> None:
    ...
    @pytest.mark.parametrize(
        "client",
        [
            AsyncFv(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            AsyncFv(
                base_url="http://localhost:5000/custom/path/",
                api_key=api_key,
                _strict_response_validation=True,
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncFv(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    async def test_retries_taken(
        ...
        response = await client.profit.with_raw_response.calculate()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.profit.with_raw_response.calculate(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.profit.with_raw_response.calculate(extra_headers={"x-stainless-retry-count": "42"})
