...
[![PyPI version](https://img.shields.io/pypi/v/fv.svg)](https://pypi.org/project/fv/)
...
pip install git+ssh://git@github.com/stainless-sdks/fv-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://app.stainless.com/docs/guides/publish), this will become: `pip install --pre fv`
...
All errors inherit from `fv.APIError`.
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/fv-python/tree/main/src/fv/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/fv-python/tree/main/src/fv/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/fv-python/issues) with questions, bugs, or suggestions.
